...
const steps = [
  ...
  {
    label: "Mortgage treatment payment plan model",
    command: process.execPath,
    args: [path.join(projectRoot, "checks/lens-analysis/mortgage-treatment-payment-plan-model-check.js")],
    cwd: projectRoot
  },
  {
    label: "Treated ongoing support model",
    command: process.execPath,
    args: [path.join(projectRoot, "checks/lens-analysis/treated-ongoing-support-model-check.js")],
    cwd: projectRoot
  },
  {
    label: "Treated ongoing support method consumption",
    command: process.execPath,
    args: [path.join(projectRoot, "checks/lens-analysis/treated-ongoing-support-method-consumption-check.js")],
    cwd: projectRoot
  },
  {
    label: "Step 3 treated ongoing support display",
    command: process.execPath,
    args: [path.join(projectRoot, "checks/lens-analysis/step-three-treated-ongoing-support-display-check.js")],
    cwd: projectRoot
  },
  {
