...
assert(/\.pmi-housing-record-field\s*\{[\s\S]*justify-self:\s*stretch;[\s\S]*width:\s*100%;/.test(housingRecordsCss), "Housing record fields should use the full grid track width.");
assert(/\.pmi-housing-record-field > span\s*\{[\s\S]*display:\s*block;[\s\S]*width:\s*100%;/.test(housingRecordsCss), "Housing record field labels should use the full field width.");
