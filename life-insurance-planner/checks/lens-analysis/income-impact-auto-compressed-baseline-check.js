...
assert.equal(result.compressionPath.formula, "ease-in-monthly-slider-ramp");
assert.equal(result.compressionPath.startSliderValue, 0);
assert.equal(result.compressionPath.endSliderValue, -100);
assert.equal(result.trace.formula, "ease-in-monthly-slider-ramp");
...
assert.equal(adjustedPoints[0].trace.autoCompressionProgress, 0, "month zero progress should be 0%");
assert.equal(adjustedPoints[1].autoCompressionSliderValue, -25, "halfway month should use 25% ease-in progress");
assert.equal(adjustedPoints[1].monthlyHouseholdExpenseDelta, -150, "halfway month should apply 25% of conservative delta");
assert.equal(adjustedPoints[1].trace.autoCompressionProgress, 0.25, "halfway progress should be 25%, not 50%");
...
assert.equal(adjustedPoints[2].trace.autoCompressionProgress, 1, "horizon progress should be 100%");
