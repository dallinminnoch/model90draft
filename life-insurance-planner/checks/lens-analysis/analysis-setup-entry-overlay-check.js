...
assert.match(overlaySection, /data-analysis-setup-view-tab="calculation"[^>]*data-analysis-setup-scroll-target="calculation-inclusion"[^>]*>Calculation inclusion controls<\/button>/);
assert.match(overlaySection, /data-analysis-setup-view-tab="calculation"[^>]*data-analysis-setup-scroll-target="inflation-assumptions"[^>]*>Inflation assumptions<\/button>/);
assert.match(overlaySection, /data-analysis-setup-view-tab="calculation"[^>]*data-analysis-setup-scroll-target="method-defaults"[^>]*>Method defaults<\/button>/);
assert.match(overlaySection, /data-analysis-setup-view-tab="calculation"[^>]*data-analysis-setup-scroll-target="policy-return-assumptions"[^>]*>Policy return assumptions<\/button>/);
assert.match(overlaySection, /data-analysis-setup-view-tab="offset"[^>]*data-analysis-setup-scroll-target="asset-treatment"[^>]*>Asset treatment<\/button>/);
assert.match(overlaySection, /data-analysis-setup-view-tab="offset"[^>]*data-analysis-setup-scroll-target="cash-reserve"[^>]*>Cash reserve<\/button>/);
assert.match(overlaySection, /data-analysis-setup-view-tab="offset"[^>]*data-analysis-setup-scroll-target="existing-coverage-treatment"[^>]*>Existing coverage treatment<\/button>/);
assert.match(overlaySection, /data-analysis-setup-view-tab="offset"[^>]*data-analysis-setup-scroll-target="debt-mortgage"[^>]*>Debt &amp; mortgage<\/button>/);
assert.match(overlaySection, /data-analysis-setup-view-tab="planning"[^>]*data-analysis-setup-scroll-target="survivor-support"[^>]*>Survivor &amp; support<\/button>/);
assert.match(overlaySection, /data-analysis-setup-view-tab="planning"[^>]*data-analysis-setup-scroll-target="education-assumptions"[^>]*>Education assumptions<\/button>/);
assert.match(overlaySection, /data-analysis-setup-view-tab="planning"[^>]*data-analysis-setup-scroll-target="recommendation-guardrails"[^>]*>Recommendation guardrails<\/button>/);
...
assert.equal(countOccurrences(html, /data-analysis-setup-view-tab=/g), 11);
...
assert.match(setupSource, /panel\.hidden = false/);
assert.match(setupSource, /function scrollAnalysisSetupViewIntoPlace\(viewName, viewPanels, viewGrid, options\)/);
assert.match(setupSource, /function getAnalysisSetupScrollTarget\(scrollTarget, viewName, viewPanels\)/);
assert.match(setupSource, /function syncAnalysisSetupMenuSelectionFromScroll\(viewTabs, viewGrid\)/);
...
assert.match(layoutCss, /\.lens-assumptions-dialog[\s\S]*width: min\(92vw, 96rem\)[\s\S]*height: min\(88vh, 54rem\)/);
assert.match(layoutCss, /\.analysis-setup-view-frame[\s\S]*grid-template-columns: minmax\(15rem, 18rem\) minmax\(0, 1fr\)/);
assert.match(layoutCss, /\.analysis-setup-panel-grid\[data-analysis-setup-current-view="calculation"\] \.analysis-setup-left-stack[\s\S]*grid-template-columns: minmax\(0, 1fr\)/);
