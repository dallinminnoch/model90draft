...
assert.doesNotMatch(overlaySection, /data-analysis-setup-view-panel="(?:offset|planning)"[^>]*\shidden\b/);
assert.doesNotMatch(overlaySection, /data-analysis-setup-view-panel="(?:offset|planning)"[^>]*data-active="false"/);
