...
assert.match(trayMarkup, /coverage-strategy-scenario-control/);
...
assert.match(componentsSource, /grid-template-columns: minmax\(13rem, 1\.1fr\) minmax\(7rem, 0\.62fr\) minmax\(8\.2rem, 0\.68fr\) minmax\(15rem, 1\.28fr\) minmax\(10\.5rem, 0\.72fr\)/);
