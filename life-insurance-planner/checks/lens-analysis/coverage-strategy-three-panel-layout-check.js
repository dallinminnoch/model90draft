...
assert.doesNotMatch(trayMarkup, /<button|<select|<textarea|data-scenario|Save scenario|Recalculate<\/button>/);
...
assert.match(componentsSource, /grid-template-columns: minmax\(12rem, 1\.5fr\) repeat\(2, minmax\(6rem, 0\.75fr\)\)/);
