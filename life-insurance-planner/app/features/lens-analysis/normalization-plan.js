  ...
  const LENS_NORMALIZATION_PLAN = {
    ...
    bucketMappings: {
      ...
      expenseFacts: [
        ...
        { rawField: "expenseRecords[]", canonicalField: "expenseFacts.expenses[]", availability: "activeLinkedPmiNormalization", note: "Repeatable PMI expense records normalize into raw expense facts alongside protected scalar final-expense rows. Repeatable final-expense component facts can feed Needs final expense projection; recurring healthcare, living, education, business, and custom facts remain raw-only." },
        { rawField: "scalar final expense fields + expenseRecords[]", canonicalField: "expenseFacts.totalsByBucket", availability: "activeLinkedPmiNormalization", note: "Backend-ready bucket totals for expense/healthcare logic. Final-expense component facts can feed Needs final expense projection, while non-final recurring facts remain raw-only and finalExpenses remains the compatibility/fallback source." },
