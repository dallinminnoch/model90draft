  ...
  const LENS_NORMALIZATION_PLAN = {
    ...
    bucketMappings: {
      ...
      expenseFacts: [
        ...
        { rawField: "expenseRecords[]", canonicalField: "expenseFacts.expenses[]", availability: "activeLinkedPmiNormalization", note: "Repeatable PMI expense records normalize into raw expense facts alongside protected scalar final-expense rows. This is a raw fact inventory only; no current methods consume these repeatable records." },
        { rawField: "scalar final expense fields + expenseRecords[]", canonicalField: "expenseFacts.totalsByBucket", availability: "activeLinkedPmiNormalization", note: "Backend-ready bucket totals for future expense/healthcare logic. Totals may include repeatable expense facts, while finalExpenses remains the current method-facing compatibility object for DIME, Needs, HLV, and Step 3." },
        { rawField: "future healthcare/final-expense split", canonicalField: null, availability: "deferred", note: "Healthcare inflation and any future split between medical final expenses and non-medical final expenses requires explicit method ownership before formulas consume expenseFacts." }
      ],
