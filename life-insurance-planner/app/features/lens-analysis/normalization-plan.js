  ...
  const LENS_NORMALIZATION_PLAN = {
    ...
    bucketMappings: {
      ...
      ongoingSupport: [
        ...
        { rawField: "expenseRecords.groceries", canonicalField: "ongoingSupport.monthlyFoodCost", availability: "activeLinkedPmiRecord", note: "Record-first starter row for monthly food and grocery cost." },
        { rawField: "expenseRecords.householdTransportation", canonicalField: "ongoingSupport.monthlyTransportationCost", availability: "activeLinkedPmiRecord", note: "Record-first starter row for monthly transportation cost." },
        { rawField: "expenseRecords.childcareExpense", canonicalField: "ongoingSupport.monthlyChildcareAndDependentCareCost", availability: "activeLinkedPmiRecord", note: "Record-first starter row for monthly childcare and dependent-care cost." },
        { rawField: "expenseRecords.internetPhone", canonicalField: "ongoingSupport.monthlyPhoneAndInternetCost", availability: "activeLinkedPmiRecord", note: "Record-first starter row for monthly phone and internet cost." },
        { rawField: "expenseRecords.householdConsumablesSupplies", canonicalField: "ongoingSupport.monthlyHouseholdSuppliesCost", availability: "activeLinkedPmiRecord", note: "Record-first starter row for monthly household essentials and supplies." },
        { rawField: "expenseRecords.medicalOutOfPocket", canonicalField: "ongoingSupport.monthlyHealthcareOutOfPocketCost", availability: "activeLinkedPmiRecord", note: "Record-first starter row mapped to ongoing support only for this phase." },
        { rawField: "expenseRecords.householdInsurancePremiums", canonicalField: "ongoingSupport.monthlyOtherInsuranceCost", availability: "activeLinkedPmiRecord", note: "Record-first starter row for monthly non-housing insurance." },
        { rawField: "expenseRecords.otherHouseholdExpenseDefault", canonicalField: "ongoingSupport.monthlyOtherHouseholdExpenses", availability: "addExpenseOnly", note: "Other Household Expenses is intentionally Add Expense only, not a starter row." },
        ...
        { rawField: "expenseRecords.recurringPersonalSpendingDefault", canonicalField: "ongoingSupport.monthlySubscriptionsCost", availability: "activeLinkedPmiRecord", note: "Record-first starter row for recurring personal spending stored separately as discretionary context and excluded from baseline support by default." },
        { rawField: "expenseRecords.entertainmentRecreation", canonicalField: "ongoingSupport.monthlyTravelAndDiscretionaryCost", availability: "activeLinkedPmiRecord", note: "Record-first starter row for entertainment and travel spending stored separately as discretionary context and excluded from baseline support by default." },
      ...
      expenseFacts: [
        { rawField: "funeralBurialEstimate", canonicalField: "expenseFacts.expenses[]", availability: "activeLinkedPmiNormalization", note: "Protected scalar-owned raw expense fact mapped to the funeralBurial bucket. Needs final expense projection can use this non-medical final-expense component through the final expense projection helper." },
        { rawField: "medicalEndOfLifeCosts", canonicalField: "expenseFacts.expenses[]", availability: "activeLinkedPmiNormalization", note: "Protected scalar-owned raw expense fact mapped to the medicalFinalExpense bucket. Needs final expense projection can use this healthcare-sensitive final-expense component through the final expense projection helper." },
        { rawField: "estateSettlementCosts", canonicalField: "expenseFacts.expenses[]", availability: "activeLinkedPmiNormalization", note: "Protected scalar-owned raw expense fact mapped to the estateSettlement bucket. Needs final expense projection can use this non-medical final-expense component through the final expense projection helper." },
        { rawField: "otherFinalExpenses", canonicalField: "expenseFacts.expenses[]", availability: "activeLinkedPmiNormalization", note: "Protected scalar-owned raw expense fact mapped to the otherFinalExpense bucket. Needs final expense projection can use this non-medical final-expense component through the final expense projection helper." },
        { rawField: "expenseRecords[]", canonicalField: "expenseFacts.expenses[]", availability: "activeLinkedPmiNormalization", note: "Repeatable PMI expense records normalize into raw expense facts alongside protected scalar final-expense rows. Repeatable final-expense component facts can feed Needs final expense projection. Eligible non-final healthcare facts feed the Needs healthcareExpenses component automatically; living, education, business, and custom expense facts remain raw-only for current outputs. DIME and HLV do not consume expenseFacts." },
        { rawField: "scalar final expense fields + expenseRecords[]", canonicalField: "expenseFacts.totalsByBucket", availability: "activeLinkedPmiNormalization", note: "Backend-ready bucket totals for expense/healthcare logic. Final-expense component facts can feed Needs final expense projection, with medical final expense handled separately through Final Expense projection. Eligible non-final healthcare facts feed Needs healthcareExpenses through the healthcare expense projection helper, while living, education, business, and custom facts remain raw-only and finalExpenses remains the compatibility/fallback source." },
