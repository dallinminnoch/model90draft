(function (global) {
  ...
  const RAW_DEBT_LIBRARY_ENTRIES = Object.freeze([
    ...
    ["secondVehicleLoan", "Second Vehicle Loan", "securedConsumerDebt", GROUPS.securedConsumerDebt, "Deprecated compatibility alias. Add another Auto Loan row for additional financed vehicles.", "second auto loan|second car loan|additional vehicle loan", { defaultPaymentType: "minimumPayment", isLease: false, balanceRequiredForDebtFacts: true, isAddable: false, isDeprecated: true, canonicalTypeKey: "autoLoan" }],
    ["secondVehicleLease", "Second Vehicle Lease", "securedConsumerDebt", GROUPS.securedConsumerDebt, "Deprecated compatibility alias. Add another Auto Lease row for additional leased vehicles.", "second auto lease|second car lease|additional vehicle lease", { defaultPaymentType: "leasePayment", isLease: true, balanceRequiredForDebtFacts: false, isAddable: false, isDeprecated: true, canonicalTypeKey: "autoLease" }],
  ...
  function toDebtLibraryEntry(definition) {
    ...
    return Object.freeze({
      ...
      isDeprecated: options.isDeprecated === true,
      canonicalTypeKey: options.canonicalTypeKey || null,
